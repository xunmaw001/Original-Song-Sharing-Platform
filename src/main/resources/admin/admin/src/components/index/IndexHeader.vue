	...
	export default {
		data() {
			return {
				...
				ruleForm: {},
				user: {},
				heads: {"headLogoutFontHoverColor":"#fff","headFontSize":"20px","headUserInfoFontColor":"rgba(169, 167, 57, 1)","headBoxShadow":"0 1px 6px #444","headTitleImgHeight":"44px","headLogoutFontHoverBgColor":"#333","headFontColor":"rgba(197, 195, 72, 1)","headTitleImg":false,"headHeight":"60px","headTitleImgBorderRadius":"22px","headTitleImgUrl":"http://codegen.caihongy.cn/20201021/cc7d45d9c8164b58b18351764eba9be1.jpg","headBgColor":"radial-gradient(circle, rgba(18,17,17,1) 0%, rgba(206,212,104,1) 9%, rgba(113,111,34,1) 21%, rgba(0,1,4,1) 51%, rgba(178,190,204,1) 100%)","headTitleImgBoxShadow":"0 1px 6px #444","headLogoutFontColor":"rgba(177, 176, 59, 1)","headUserInfoFontSize":"16px","headTitleImgWidth":"44px","headTitleStyle":"1","headLogoutFontSize":"16px"},
			};
		},
		created() {
			this.setHeaderStyle()
