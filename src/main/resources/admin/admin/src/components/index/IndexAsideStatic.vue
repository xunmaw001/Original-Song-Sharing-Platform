      ...
      this.$nextTick(()=>{
        document.querySelectorAll('.menulist .el-menu-item').forEach(el=>{
          el.addEventListener("mouseenter", e => {
            e.stopPropagation()
            el.style.backgroundColor = "rgba(166, 166, 166, 1)"
          })
          el.addEventListener("mouseleave", e => {
            e.stopPropagation()
            // el.style.backgroundColor = "radial-gradient(circle, rgba(18,17,17,1) 0%, rgba(113,111,34,1) 0%, rgba(206,212,104,1) 26%, rgba(0,1,4,1) 51%, rgba(178,190,204,1) 100%)"
  ...
  .index-aside {
    ...
    .menulistImg {
      ...
      .el-image {
		...
		background: radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(164,167,77,1) 27%, rgba(0,0,0,1) 58%, rgba(0,0,0,1) 76%, rgba(166,177,190,1) 100%) !important;
